...
// import { userResetForgotPasswordValidator } from "../validators/auth.validators.js"
...
const resendEmailVerification = asyncHandler(async (req, res) => {
    ...
    .json(
        new ApiResponse(
            200,
            {},
            "Mail has been sent to user emailID"
        )
    )
...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
    ...
    .json(
        new ApiResponse(
            200,
            {},
            "Password reset mail has been on your mail id "
        )
    )
})
